...
dist: build-cross
	( \
		...
		$(DIST_DIRS) tar -zcf boss-${VERSION}-{}.tar.gz {} \; && \
		$(DIST_DIRS) zip -r boss-${VERSION}-{}.zip {} \; \
	)
.PHONY: checksum
checksum:
